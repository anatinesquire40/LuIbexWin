...
// Llame Lua a esta funci�n para obtener el mensaje formateado
Lua_Function(FormatMessage)
{
    ...
    // Creamos un arreglo de LPVOID para los argumentos que usar� FormatMessage
    LPVOID* args = NULL;
    int i;
    // Variables auxiliares para argumentos num�ricos (evitar punteros a est�ticos)
    int* numArgs = NULL;
    ...
    if (nargs > 0)
    {
        ...
        // Para n�meros almacenamos en heap para evitar errores
